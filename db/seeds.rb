...
product_1= Product.create(user_id: user_1, category_id: category_2, title: 'Product 1', description: 'General', goal: '12345', decimal: 'hi',
               finishDate: DateTime.new(2019, 05, 15), mainImage: 'bleh.jpg', mainVideo: 'bleh.mp4', rating: 0)
product_2= Product.create(user_id: user_2, category_id: category_1, title: 'Product 2', description: 'General', goal: '12345', decimal: 'hi',
               finishDate: DateTime.new(2019, 05, 15), mainImage: 'bleh.jpg', mainVideo: 'bleh.mp4', rating: 0)
product_3= Product.create(user_id: user_3, category_id: category_2, title: 'Product 3', description: 'General', goal: '12345', decimal: 'hi',
               finishDate: DateTime.new(2019, 05, 15), mainImage: 'bleh.jpg', mainVideo: 'bleh.mp4', rating: 0)