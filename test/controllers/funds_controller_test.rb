...
class FundsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fund" do
    assert_difference('Fund.count') do
      post funds_url, params: { fund: { amountFunded: @fund.amountFunded, product_id: @fund.product_id, user_id: @fund.user_id } }
    end
  ...
  test "should update fund" do
    patch fund_url(@fund), params: { fund: { amountFunded: @fund.amountFunded, product_id: @fund.product_id, user_id: @fund.user_id } }
